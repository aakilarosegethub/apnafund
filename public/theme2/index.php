...
?>
        ...
        <div class="slider" id="slider">
            ...
            <div class="slide"><img src="img/one.webp" alt="slide1"></div>
            <div class="slide"><img src="img/two.webp" alt="slide2"></div>
            <div class="slide"><img src="img/three.webp" alt="slide3"></div>
            </div>
        </div><!--slider-->
                ...
                <div class="inside-categories">
                    <div class="section-category">
                        <a href="categories.php">    
                            <img src="img/1a01e271eb302636eaec73d32fae39ef.webp">
                            <p>Beauty And Personal Care </p>
                        </a>
                    </div><!--section-category-->
                    <div class="section-category">
                        <a href="categories.php">    
                            <img src="img/2b118f1d211ffadea2e9fcd90e9d6366.webp">
                            <p>Beauty And Personal Care </p>
                        </a>
                    </div><!--section-category-->
                    <div class="section-category">
            ...
            <div class="container">
                <div class="inside-photos-section">
                    <div class="photos-section-part">
                        <a href="#"> <img src="img/7a04eb6b0ca74b89f482b50892a82702.webp"> </a>
                    </div><!--photos-section-->
                    <div class="photos-section-part">
                        <a href="#"> <img src="img/twoo.webp"> </a>
                    </div><!--photos-section-->
                    <div class="photos-section-part">
                        <a href="#"> <img src="img/onee.webp"> </a>
                    </div><!--photos-section-->
                ...
                <div class="inside-new-arrivals">
                    ...
                    <div class="slider-wrapper" data-slider="products">
                        <button class="product-slide-btn left prev">&#10094;</button>
                            ...
                            <a href="single-product-page.php" class="product-link">    
                                <div class="single-product-section product">
                                    <div class="product-image">
                                        <a href="single-product-page.php"> <img src="img/serum.webp"></a>
                                    </div><!--product-image-->
        ...
        <div class="single-photos-section">
            <div class="container">
                <div class="sin-photos-section-part">
                    <a href="#"> <img src="img/fashion.webp"> </a>
                </div><!--photos-section-->
            </div><!--cont-->
        ...
        <div class="new-arrivals">
            <div class="container">
                <div class="inside-new-arrivals">
                    <div class="new-arrivals-heading">
                        <h1> <a href="#"> Face Serum </a> </h1>
                    </div><!--new-arrivals-heading-->

                    <div class="slider-wrapper" data-slider="face-serum">
                        <button class="product-slide-btn left prev">&#10094;</button>
                            <div class="products-section" >
                                <div class="single-product-section product">
                                    <div class="product-image">

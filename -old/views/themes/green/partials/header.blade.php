...
/* Logo wrapper attached to left edge, bigger size, right-side border-radius only */
.logo-wrapper {
    display: inline-block;
    background: #ffffff;
    border-top-right-radius: 50px;
    border-bottom-right-radius: 50px;
    padding: 3px 42px; /* height aur width thodi badi kar di */
        margin-top: 14px;    /* upar 5px gap */
    margin-bottom: 5px; /* neeche 5px gap */
    position: absolute; /* left edge par attach karne ke liye */
    left: 0;
    top: 0;             /* header ke top se start */
      height: 70px;      /* height adjust kiya jisse logo wrapper bada lage */
    display: flex;
    align-items: center; /* vertically center the logo image */
    transition: all 0.3s ease;
    z-index: 10;        /* header ke elements ke upar rahe */
}
...
/* Logo image adjust */
.logo-img {
   height: 36px; /* logo image height adjust kiya wrapper ke hisab se */
    width: auto;
}
...
<div class="col-12 col-md-2 text-center text-md-start">
    <a href="{{ url('/') }}" class="logo-wrapper">
        <img src="{{ getImage(getFilePath('logoFavicon') . '/logo_light.png', getFileSize('logoFavicon')) }}" 
             alt="Apna Crowdfunding Logo" class="logo-img">
    </a>
</div>

            ...
            <div class="card-body">
                <form class="row g-lg-4 g-3" action="{{ route('admin.notification.welcome.update') }}" method="POST">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        ...
                        <input type="text" class="form--control" name="email_subject" value="Welcome to {!! apnaCrowdfundingLink() !!} - Account Created Successfully!" required>
                    </div>
                        ...
                        <div class="row g-4">
                            <div class="col-xl-6 col-lg-12 col-md-6">
                                ...
                                <textarea class="form--control email-body-html" name="email_body" required>
                                    <h1>Welcome to {!! apnaCrowdfundingLink() !!}!</h1>
                                    <p>Dear {{firstname}} {{lastname}},</p>
                                    <p>Welcome to {!! apnaCrowdfundingLink() !!}! Your account has been created successfully.</p>
                                    ...
                                    <p>Best regards,<br>{!! apnaCrowdfundingLink() !!} Team</p>
                                </textarea>
                            </div>
                            <div class="col-xl-6 col-lg-12 col-md-6">

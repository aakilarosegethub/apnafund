                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form--control" name="subject" 
                                   value="🎉 Welcome to ApnaFund - Your Journey Begins!" required>
...
🌟 Welcome to ApnaFund! We're thrilled to have you join our community of entrepreneurs and innovators.

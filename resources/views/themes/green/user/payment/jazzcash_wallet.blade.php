...
function initJazzCashWallet() {
    if (typeof $ === 'undefined') {
        ...
        setTimeout(initJazzCashWallet, 100);
        return;
    }
    
    console.log('jQuery loaded, initializing JazzCash Wallet form...');
    $(document).ready(function() {
    console.log('jQuery ready, initializing JazzCash Wallet form...');
    ...
    $('#jazzcash-wallet-form').on('submit', function(e) {
        ...
        // Make AJAX request
        console.log('Making AJAX request to: {{ route("ipn.JazzCashWallet.process") }}');
        console.log('Form data:', $(this).serialize());
        $.ajax({
            url: '{{ route("ipn.JazzCashWallet.process") }}',
            method: 'POST',
            data: $(this).serialize(),
            headers: {

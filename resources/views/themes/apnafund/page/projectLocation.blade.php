...
@section('frontend')
    ...
    <div class="setup-container">
        ...
        <form id="locationForm">
            ...
            <div class="info"><a href="{{ route('rules') }}" target="_blank" rel="noopener" style="color: inherit; text-decoration: underline;">Who's eligible to run a {{ bs('site_name') ?? 'ApnaCrowdfunding' }} project?</a></div>

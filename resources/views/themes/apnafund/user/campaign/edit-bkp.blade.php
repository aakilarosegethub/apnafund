...
<script type="text/javascript">
    (function($) {
        ...
        $(document).ready(function() {
            ...
            // Initialize datepicker with error Shandling
        ...
        */
        ...
        $('#editGigForm').on('submit', function(e) {
            ...
            var formData = new FormData(this);
                            ...
                            // Form data is already set from the form
        ...
        function validateForm() {
            ...
            let description = $('#gigDescription').val().trim();
...
<script>
    const editor = Jodit.make('#gigDescription', {
        ...
        removeButtons: ['font', 'fontsize', 'brush', 'paragraph'],

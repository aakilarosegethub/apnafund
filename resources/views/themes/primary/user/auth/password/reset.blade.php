...
<div class="reset-page-container">
    ...
    <div class="reset-illustration">
        <div class="illustration-container">
            ...
            <div class="illustration-content">
                ...
                <p class="illustration-subtitle">Create Your New Password</p>
    ...
    <div class="reset-form-section">
        <div class="reset-header">
            <h2 class="reset-title">{{ __(@$passwordResetContent->data_info->form_heading) ?: 'Create New Password' }}</h2>
            <p class="reset-subtitle">Enter your new password below to complete the reset process.</p>
        </div>
        ...
        <form action="{{ route('user.password.reset') }}" method="POST" id="resetForm">
            ...
            <div class="form-group">
                ...
                <div class="password-input-container">
                    <input type="password" class="form-control @if ($setting->strong_pass) secure-password @endif" 
                ...
                @if ($setting->strong_pass)
                    <div class="password-requirements">
                        <div class="password-requirement">
                            <span class="requirement-icon invalid" id="capital-icon">✗</span>
                            <span class="requirement-text">@lang('At least one uppercase letter')</span>
                        </div>
                        <div class="password-requirement">
                            <span class="requirement-icon invalid" id="lower-icon">✗</span>
                            <span class="requirement-text">@lang('At least one lowercase letter')</span>
                        </div>
                        <div class="password-requirement">
                            <span class="requirement-icon invalid" id="number-icon">✗</span>
                            <span class="requirement-text">@lang('At least one number')</span>
                        </div>
                        <div class="password-requirement">
                            <span class="requirement-icon invalid" id="special-icon">✗</span>
                            <span class="requirement-text">@lang('At least one special character')</span>
                        </div>
                        <div class="password-requirement">
                            <span class="requirement-icon invalid" id="length-icon">✗</span>
...
function checkPasswordStrength(password) {
    ...
    // Update icons
    updateRequirement('capital-icon', capital);
    updateRequirement('lower-icon', lower);
    updateRequirement('number-icon', number);
    updateRequirement('special-icon', special);
    updateRequirement('length-icon', length);

    // Update strength bar
    const strengthBar = document.getElementById('strength-bar');
    if (strengthBar) {
        const validCount = [capital, lower, number, special, length].filter(Boolean).length;

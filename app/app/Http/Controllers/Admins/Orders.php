...
class Orders extends Controller
{
    ...
    public function custom_api()
    {
        ...
        foreach ($ret as $k => $v) {
            ...
            $data[] = [$checkbox, $start + $i, $v->product_name, $v->customer_name, $v->mobile_number, $v->quantity, $v->address, $st, $actions];
        }
    ...
    public function dispatch_api()
    {
        ...
        foreach ($ret as $k => $v) {
            ...
            $data[] = [$start + $i, $v->product_name, $v->customer_name, $v->mobile_number, $v->quantity, $v->address, $st, $actions];
        }

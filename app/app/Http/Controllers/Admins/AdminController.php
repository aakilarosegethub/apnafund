...
class AdminController extends Controller
{
    ...
    public function products_api()
    {
        ...
        <div class="onoffswitch">
            ...
            $data[] = [$start + $i, $image, $v->product_code, $v->product_name, $category_name, $v->product_quantity, $st, $action];
        }

        $r = ['draw' => $_GET['draw'], 'recordsTotal' => count($tot), 'recordsFiltered' => count($tot), 'data' => $data];
        echo json_encode($r);
        exit();
    }
    ...
    public function review(Request $request, $id = 0, $delete = null)
    {
        ...
        $r = DB::table('rating')->update(['is_read' => 1]);
    ...
    public function orders(Request $request)
    {
        ...
        $r = DB::table('orders')->update(['is_read' => 1]);
    ...
    public function orders_all_api()
    {
        ...
        ';
            ...
            $data[] = [$start + $i, $v->customer_name, $v->phone, $v->email, $v->city, $v->address, $st, $actions];
        }

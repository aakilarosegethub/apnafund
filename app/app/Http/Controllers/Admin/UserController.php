...
class UserController extends Controller
{
    ...
    public function kycUnConfirmed()
    {
    ...
    public function emailUnConfirmed()
    {
    ...
    public function mobileUnConfirmed()
    {
    ...
    public function sendBulkEmailToUsers()
    {
        $this->validate(request(), [
    ...
    public function testWelcomeEmail($id)
    {
        $user = User::findOrFail($id);
    ...
    public function testEmailToLastUser()
    {
    ...
    public function sendWelcomeToRecentUsers()
    {
    ...
    public function sendWelcomeToRecentUsersPost()
    {
        $this->validate(request(), [
            'user_ids' => 'required|array|min:1',
        ]);
    ...
    public function welcomeTemplateEditor()
    {
    ...
    public function welcomeTemplateUpdate()
    {
        $this->validate(request(), [
            'subject' => 'required|string|max:255',

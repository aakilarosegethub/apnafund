...
class FrontController extends Controller
{
    ...
    public function index()
    {
        ...
        $xml .= '</urlset>';
        $myfile = fopen('sitemap.xml', 'w') or exit('Unable to open file!');
        $r = fwrite($myfile, $xml);
        fclose($myfile);
    ...
    public function categories()
    {
        ...
        $xml .= '</urlset>';
        $myfile = fopen('category.xml', 'w') or exit('Unable to open file!');
        $r = fwrite($myfile, $xml);
        fclose($myfile);
    ...
    public function products_tag()
    {
        ...
        $xml .= '</urlset>';
        $myfile = fopen('product_tags.xml', 'w') or exit('Unable to open file!');
        $r = fwrite($myfile, $xml);
        fclose($myfile);
                    ...
                    if ($response['parent_cat']) {
                        ...
                        if ($pcat && isset($pcat['name'])) {
                            ...
                            if (! $al) {
                                ...
                                $up = ['category_id' => $pcatID];

                                $r = DB::table('products')->where('id', $pro)->update($up);
                            } else {
                                $pcatID = $al->id;
                                $up = ['category_id' => $al->id];
                    ...
                    if ($response['sub_cat']) {
                        ...
                        if ($pcat && isset($pcat['name'])) {
                            ...
                            if (! $al) {
                                ...
                                $up = ['subcategory_id' => $pcat];
                                Product::where('id', $pro)->update($up);
                            } else {
                                $up = ['subcategory_id' => $al->id];
    ...
    public function product_detail($slug)
    {
        ...
        if (count($product) > 0) {
            ...
            if ($meta) {
                ...
                if (isset($jayParsedAry['review']) && empty($jayParsedAry['review'])) {
                    unset($jayParsedAry['review']);
                }
                if (isset($jayParsedAry['aggregateRating']) && empty($jayParsedAry['aggregateRating'])) {
                    unset($jayParsedAry['aggregateRating']);
                }
    ...
    public function my_wishlist(Request $request)
    {
        ...
        // dd($best);
        return $this->view('my_wishlist', ['page' => $page, 'best' => $best, 'title' => 'My Wishlist']);
    }
    ...
    public function shop(Request $request)
    {
        ...
        return $this->view('list', ['page' => $page, 'products' => $products, 'title' => 'Shop']);
    }
    ...
    public function scategory_detail($slug)
    {
        ...
        if ($category_id) {
            ...
            return $this->view('list', ['page' => $page, 'products' => $products, 'title' => 'Shop', 'meta_file' => $meta_file, 'meta' => $meta, 'category_id' => $category_id, 'best' => $best, 'seo' => $seo, 'category' => $category, 'sub_cat' => $sub_cat, 'pcategory' => $pcategory]);
        } else {
            return abort(404);
        }
    ...
    public function category_detail($slug)
    {
        ...
        if (! $category_id) {
            ...
            if ($subcategory_id) {
                ...
                return $this->view('list', ['page' => $page, 'products' => $products, 'title' => 'Shop', 'meta_file' => $meta_file, 'meta' => $meta, 'category_id' => $subcategory_id, 'best' => $best, 'seo' => $seo, 'category' => $category, 'sub_cat' => $sub_cat, 'pcategory' => $pcategory]);
            } else {
        ...
        return $this->view('list', ['page' => $page, 'products' => $products, 'title' => 'Shop', 'meta_file' => $meta_file, 'meta' => $meta, 'category_id' => $category_id, 'best' => $best, 'seo' => $seo, 'category' => $category, 'sub_cat' => $sub_cat]);
    ...
    public function checkout()
    {
        ...
        if (Session::get('user')) {
            ...
            return $this->view('checkout', ['user' => $user]);
        } else {
    ...
    public function page_detail($slug)
    {
        ...
        if ($title) {
            return $this->view('dynamicpage', ['title' => $title, 'pages' => $pages, 'slug' => $slug, 'Slider' => $Slider, 'meta_file' => $meta_file, 'size' => $size, 'colors' => $colors, 'shap' => $shap]);
        } else {
            return abort(404);
        }
    }
    ...
    public function tags_detail($slug)
    {
        ...
        return $this->view('list', ['products' => $rproducts, 'title' => $nslug, 'tags' => $tags, 'slug' => $slug, 'meta_file' => $meta_file, 'product' => $product, 'pagination' => 0]);
    }
